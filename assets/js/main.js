...
(function() {
  ...
  /**
   * Preloader
   * - Remove as soon as DOM is ready (prevents "infinite loading" if any asset hangs)
   * - Also remove on window load (keeps original behavior)
   * - Safety timeout as a last resort
   */
